---
title: "自然历史馆藏错误标本能计算机视觉方法 Mislabelled Specimens"
pdf: "[[自然历史馆藏错误标本能计算机视觉方法 Mislabelled Specimens.pdf]]"
...
**文件名模式**: `自然历史馆藏错误标本能计算机视觉方法 Mislabelled Specimens`
...
> 用 `[[]]` 链接到其他论文笔记或主题首页, 例如 [[T_通用_NLP_其他]]。
