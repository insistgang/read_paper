...
pdf: "[[Contrastive_and_Selective_Hidden_Embeddings_for_Medical_Image_Segmentation.pdf]]"
primary_topic: "A1_医学图像_分割"
topics: [A1_医学图像_分割, F_图像分割_语义_实例_全景, Q_自监督_对比学习_主动学习]
status: unread
...
**文件名模式**: `Contrastive_and_Selective_Hidden_Embeddings_for_Medical_Image_Segmentation`
...
- 属于主题: **A1_医学图像_分割**
- 关联主题: F_图像分割_语义_实例_全景, Q_自监督_对比学习_主动学习
