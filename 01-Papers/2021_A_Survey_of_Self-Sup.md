---
title: "A Survey of Self Sup"
pdf: "[[2021_A_Survey_of_Self-Sup.pdf]]"
primary_topic: "Q_自监督_对比学习_主动学习"
topics: [Q_自监督_对比学习_主动学习, R_综述_Survey]
status: unread
...
**文件名模式**: `2021_A_Survey_of_Self-Sup`

## 可能研究方向

> 基于 primary_topic + topics 推测, 仅作入门指引。

- 属于主题: **Q_自监督_对比学习_主动学习**
- 关联主题: R_综述_Survey
...
> 用 `[[]]` 链接到其他论文笔记或主题首页, 例如 [[Q_自监督_对比学习_主动学习]]。
