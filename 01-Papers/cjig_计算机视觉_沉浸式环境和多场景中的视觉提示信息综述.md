---
title: "cjig 计算机视觉 沉浸式环境和多场景中的视觉提示信息综述"
pdf: "[[cjig_计算机视觉_沉浸式环境和多场景中的视觉提示信息综述.pdf]]"
primary_topic: "R_综述_Survey"
topics: [R_综述_Survey, T_通用_NLP_其他]
status: unread
...
# cjig 计算机视觉 沉浸式环境和多场景中的视觉提示信息综述
...
**文件名模式**: `cjig_计算机视觉_沉浸式环境和多场景中的视觉提示信息综述`
...
> 用 `[[]]` 链接到其他论文笔记或主题首页, 例如 [[R_综述_Survey]]。
