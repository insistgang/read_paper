---
title: "Vision Language Mode"
pdf: "[[2023_Vision-Language_Mode.pdf]]"
primary_topic: "G_视觉基础模型_VLM_LLM"
topics: [G_视觉基础模型_VLM_LLM, R_综述_Survey, T_通用_NLP_其他]
status: unread
...
**文件名模式**: `2023_Vision-Language_Mode`

## 可能研究方向

> 基于 primary_topic + topics 推测, 仅作入门指引。

- 属于主题: **G_视觉基础模型_VLM_LLM**
- 关联主题: R_综述_Survey, T_通用_NLP_其他
...
> 用 `[[]]` 链接到其他论文笔记或主题首页, 例如 [[G_视觉基础模型_VLM_LLM]]。
