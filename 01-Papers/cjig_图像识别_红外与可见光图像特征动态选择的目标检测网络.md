---
title: "cjig 图像识别 红外与可见光图像特征动态选择的目标检测网络"
pdf: "[[cjig_图像识别_红外与可见光图像特征动态选择的目标检测网络.pdf]]"
primary_topic: "C_目标检测_通用与旋转框"
topics: [C_目标检测_通用与旋转框, C3_目标检测_红外_可见光融合]
status: unread
...
# cjig 图像识别 红外与可见光图像特征动态选择的目标检测网络
...
**文件名模式**: `cjig_图像识别_红外与可见光图像特征动态选择的目标检测网络`
