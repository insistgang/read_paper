---
title: "Detecting the Presen"
pdf: "[[2020_Detecting_the_Presen.pdf]]"
primary_topic: "R1_遥感_高光谱_变化检测"
topics: [R1_遥感_高光谱_变化检测]
status: unread
...
**文件名模式**: `2020_Detecting_the_Presen`
...
> 用 `[[]]` 链接到其他论文笔记或主题首页, 例如 [[R1_遥感_高光谱_变化检测]]。
