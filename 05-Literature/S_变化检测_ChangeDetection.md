...
- **主题名**: 变化检测
- **代号**: `S_变化检测_ChangeDetection`
- **论文数**: 7
- **年份分布**: 2019: 3, 2023: 2, 2020: 1

## 论文列表 (按年份排序)

- 2019 [[2019_Change_Detection_and]]
- 2019 [[2019_Object_Contour_and_E]]
- 2019 [[2019_Semantic_Change_and]]
- 2020 [[2020_A_computer-friendly]]
- 2023 [[2023_An_Aligned_Multi-Tem]]
- 2023 [[2023_Laplacian_Change_Poi]]
- ???? [[cjig_遥感_高分遥感影像变化检测]]
...
FROM "01-Papers"
WHERE primary_topic = "S_变化检测_ChangeDetection"
SORT year DESC
```
...
TABLE year, primary_topic, status
FROM "01-Papers"
WHERE contains(topics, "S_变化检测_ChangeDetection")
SORT year DESC
```
