...
- 2025 [[2025_Remote_Sensing_Retri]]
- ???? [[深度学习的跨视角地理定位方法综述]]  _R_综述_Survey/T_通用_NLP_其他_
- ???? [[预训练大模型技术在行人重识别的应用综述]]  _R_综述_Survey_
...
FROM "01-Papers"
WHERE primary_topic = "M_行人_重识别_检索"
SORT year DESC
```
...
TABLE year, primary_topic, status
FROM "01-Papers"
WHERE contains(topics, "M_行人_重识别_检索")
SORT year DESC
```
