...
- **代号**: `Q_自监督_对比学习_主动学习`
- **论文数**: 5
- **年份分布**: 2021: 2, 2022: 2, 2024: 1

## 论文列表 (按年份排序)

- 2021 [[2021_A_Survey_of_Self-Sup]]  _R_综述_Survey_
- 2021 [[2021_Active_learning_for]]  _T_通用_NLP_其他_
- 2022 [[2022_Reinforcement-based]]  _T_通用_NLP_其他_
- 2022 [[2022_Self-supervised_Lear]]  _T_通用_NLP_其他_
- 2024 [[2024_Reinforcement_Learni]]  _T_通用_NLP_其他_
...
WHERE primary_topic = "Q_自监督_对比学习_主动学习"
SORT year DESC
```
...
TABLE year, primary_topic, status
FROM "02-Notes/Papers"
WHERE contains(topics, "Q_自监督_对比学习_主动学习")
SORT year DESC
```
