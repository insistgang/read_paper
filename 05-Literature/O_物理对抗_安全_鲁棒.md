...
- 2021 [[2021_Physical_Adversarial]]
- ???? [[针对视觉深度学习模型的物理对抗攻击研究综述]]  _R_综述_Survey_
...
FROM "01-Papers"
WHERE primary_topic = "O_物理对抗_安全_鲁棒"
SORT year DESC
```
...
TABLE year, primary_topic, status
FROM "01-Papers"
WHERE contains(topics, "O_物理对抗_安全_鲁棒")
SORT year DESC
```
