# 医学图像配准/张量数学 (`A3_医学图像_配准_切片_张量_数学`)
...
- **主题名**: 医学图像配准/张量数学
- **代号**: `A3_医学图像_配准_切片_张量_数学`
- **论文数**: 3
- **年份分布**: _(暂未提取到年份)_

## 论文列表 (按年份排序)

- ???? [[A-prior-knowledge-guided-distributionally-robust-optimization_2024_Informati]]
- ???? [[Correlated-and-individual-feature-learning-with-contrast-enha_2023_Pattern-R]]
- ???? [[Robust-and-fast-stochastic-4D-flow-vector-field-signature-techn_2024_Medical]]
...
FROM "01-Papers"
WHERE primary_topic = "A3_医学图像_配准_切片_张量_数学"
SORT year DESC
```
...
TABLE year, primary_topic, status
FROM "01-Papers"
WHERE contains(topics, "A3_医学图像_配准_切片_张量_数学")
SORT year DESC
```
